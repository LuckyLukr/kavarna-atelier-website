      ...
      <div className="relative mx-auto grid min-h-[100svh] max-w-7xl items-end gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-20">
        <div className="max-w-3xl py-10 sm:py-16 lg:py-24">
          <span className="mb-5 inline-flex items-center rounded-full border border-gold/25 bg-white/5 px-4 py-2 text-xs font-bold uppercase tracking-[0.24em] text-gold">
            Prémiová káva • Designový interiér • Nezapomenutelná atmosféra
          </span>
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 shadow-soft">
              ...
              <p className="mt-1 text-sm text-cream/65">Ranní káva i večerní atmosféra</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 shadow-soft">
              <p className="text-2xl font-extrabold text-gold">Premium</p>
              <p className="mt-1 text-sm text-cream/65">Důraz na design a detail</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 shadow-soft col-span-2 sm:col-span-1">
              <p className="text-2xl font-extrabold text-gold">Centrum Brna</p>
              <p className="mt-1 text-sm text-cream/65">Snadno dostupná lokalita</p>
            </div>
          </div>
        </div>

        <div className="hidden lg:block">
          <div className="gold-ring rounded-[2rem] border border-white/10 bg-white/5 p-5">
            <div className="rounded-[1.5rem] border border-gold/15 bg-noir/50 p-6">
